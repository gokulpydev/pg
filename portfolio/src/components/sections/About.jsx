...
const About = () => {
    ...
    const backendSkills = ["Node.js","python","AWS","MongoDB","Svelte"];
  return (
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-6 mt-8'>
               <div className='p-6 rounded-xl border-white/10 border hover:-translate-y-1 transition-all'>
                 ...
                 <ul className='list-disc list-inside text-gray-300 space-y-2'>
                     <li>
                        <strong>Bachelor of Computer Applications</strong> -St. joseph's college of arts and science(autonomous) -Affialited to Annamalai University 
                        (2021-2024)
                     </li>
                     <li>
